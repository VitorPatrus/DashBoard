...
function insertPreviousWeekDates() {
    ...
    placeholderElement.innerHTML = `Atividades trabalhadas durante o período ${formattedMonday} à ${formattedFriday}`;
...
var chart = bb.generate({
    data: {
      ...
      colors: {
        Fora: "rgb(211, 48, 67)",
        Dentro: "rgb(65, 196, 100)",
        Pendente: "rgb(255, 205, 30)"
      }
    },
    arc: {
      cornerRadius: 80
  ...
  // Aumenta a fonte dos labels do gráfico
  var css = '.bb-chart-arc text { font-size: 20px; }',
